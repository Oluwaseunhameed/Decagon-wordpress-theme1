...
<body>
      ...
      <div class="container">
        <nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-transparent">
          <div class="container-fluid">
            <a class="navbar-brand" href="/"><img src="assets/img/logo-white.svg" alt="DecagonHQ" class="header__logo" /></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <li class="nav-item">
                  <a class="nav-link" href="https://applications.decagonhq.com/">For Developers</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="https://blog.decagonhq.com/">Blog</a>
                </li>
                <li class="nav-item">
                  <a href="contact.php" class="nav-link nav-btn">Get Started</a>
                </li>
              </ul>
            </div>
          </div>
  ...
  <section class="section-partners">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-8">
          <div class="work-with">
            <img src="./assets/img/partners/merck.svg" alt="Merck" />
            <img src="./assets/img/partners/nike.svg" alt="Nike" />
            <img src="./assets/img/partners/mastercard.svg" alt="Mastercard" />
            <img src="./assets/img/partners/vertex.svg" alt="Vertex" /><img src="./assets/img/partners/budweiser.svg" alt="Budweiser" />
            <img src="./assets/img/partners/nokia.svg" alt="Nokia" />
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="section-why">
    <div class="container">
      ...
      <div class="why-grid">
        <div class="why-image">
          <img src="./assets/img/workspace.jpg" class="img-fluid" alt="" />
        </div>
    ...
    <div class="testimonial">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-5">
            <img src="./assets/img/team2 1.jpg" alt="Jeff Jack" class="img-fluid" />
          </div>
        ...
        <div class="leader--grid">
          <div class="leader--card">
            <div class="leader--card__img">
              <img src="./assets/img/leadership/chika-nwobi.jpg" alt="Chika Nwobi" class="img-fluid" />
            </div>
            ...
            <div class="leader--card__linkedin">
              <a href="https://www.linkedin.com/in/chikanwobi/" target="_blank" rel="noopener noreferrer">
          ...
          <div class="leader--card">
            <div class="leader--card__img">
              <img src="./assets/img/leadership/laurens-kreuze.jpg" alt="Laurens Kreuze" class="img-fluid" />
            </div>
            ...
            <div class="leader--card__linkedin">
              <a href="https://www.linkedin.com/in/laurens-kreuze/" target="_blank" rel="noopener noreferrer">
                <img src="./assets/img/linkedin.svg" alt="LinkedIn" />
                <span>Find on LinkedIn &rarr;</span>
              </a>
            </div>
          ...
          <div class="leader--card">
            <div class="leader--card__img">
              <img src="./assets/img/leadership/emilly-liggette.jpg" alt="Emilly Liggett" class="img-fluid" />
            </div>
            ...
            <div class="leader--card__linkedin">
              <a href="https://www.linkedin.com/in/emilyliggett/" target="_blank" rel="noopener noreferrer">
                <img src="./assets/img/linkedin.svg" alt="LinkedIn" />
                <span>Find on LinkedIn &rarr;</span>
              </a>
            </div>
          ...
          <div class="leader--card mlc hide__leader--card">
            <div class="leader--card__img">
              <img src="./assets/img/leadership/jody-ike.jpg" alt="Jody Ike" class="img-fluid" />
            </div>
            ...
            <div class="leader--card__linkedin">
              <a href="https://www.linkedin.com/in/jody-samuels-ike-10445a2" target="_blank" rel="noopener noreferrer">
                <img src="./assets/img/linkedin.svg" alt="LinkedIn" />
                <span>Find on LinkedIn &rarr;</span>
              </a>
            </div>
          ...
          <div class="leader--card mlc hide__leader--card">
            <div class="leader--card__img">
              <img src="./assets/img/leadership/nkem-alozie.png" alt="Nkem Alozie" class="img-fluid" />
            </div>
            ...
            <div class="leader--card__linkedin">
              <a href="https://www.linkedin.com/in/nkemakonam/" target="_blank" rel="noopener noreferrer">
                <img src="./assets/img/linkedin.svg" alt="LinkedIn" />
                <span>Find on LinkedIn &rarr;</span>
              </a>
            </div>
          ...
          <div class="leader--card mlc hide__leader--card">
            <div class="leader--card__img">
              <img src="./assets/img/leadership/joseph-abah.jpg" alt="Joseph Abah" class="img-fluid" />
            </div>
            ...
            <div class="leader--card__linkedin">
              <a href="https://www.linkedin.com/in/abahjoseph/" target="_blank" rel="noopener noreferrer">
                <img src="./assets/img/linkedin.svg" alt="LinkedIn" />
                <span>Find on LinkedIn &rarr;</span>
              </a>
            </div>
    ...
    <div class="container">
      <div class="our-partners">
        ...
        <div class="our-partners--images">
          <img src="./assets/img/atlassian.svg" alt="Atlassian" class="img-fluid" />
          <img src="./assets/img/microsoft.svg" alt="Microsoft" class="img-fluid" />
          <img src="./assets/img/github.svg" alt="Github" class="img-fluid" />
        </div>
      </div>
    </div>
  ...
  <section class="section-media">
    <div class="container">
      ...
      <div class="media-grid">
        <div class="news-card" style="background-image: url(/assets/img/FEB_6268\ 1.jpg)">
          <a href="https://techpoint.africa/2020/02/04/indeed-visits-decagon-institute/" class="news-card__overlay"></a>
          <div class="news-card__details">
            <h4>Indeed Visits DecagonHQ to meet remote team</h4>
            <a href="https://techpoint.africa/2020/02/04/indeed-visits-decagon-institute/">Read More</a>
          </div>
        </div>

        <div class="news-card" style="background-image: url(/assets/img/obaseki\ 1.jpg)">
          <a href="http://www.edostate.gov.ng/obaseki-set-to-launch-edo-tech-park-partners-decagon-to-train-15000-software-engineers/" class="news-card__overlay"></a>
          <div class="news-card__details">
            <h4>Decagon to train 15,000 people in Edo state</h4>
            <a href="http://www.edostate.gov.ng/obaseki-set-to-launch-edo-tech-park-partners-decagon-to-train-15000-software-engineers/">Read More</a>
          </div>
        </div>

        <div class="news-card" style="background-image: url(/assets/img/Decagon-02-2\ 1.jpg)">
          <a href="https://tribuneonlineng.com/sterling-bank-decagon-train-5000-nigerian-graduates-on-software-engineering/" class="news-card__overlay"></a>
          <div class="news-card__details">
            <h4>Sterling Bank signs deal to finance Decadev program</h4>
            <a href="https://tribuneonlineng.com/sterling-bank-decagon-train-5000-nigerian-graduates-on-software-engineering/">Read More</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <section class="footer-section">
        <div class="row">
          <div class="col-lg-5 cp-col">
            <img src="./assets/img/logo-white.svg" class="logo" alt="Decagon" />
